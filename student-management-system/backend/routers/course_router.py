...
from models.schemas import CourseSchema, CourseCreate, CourseUpdate, CourseEnrollmentSchema
...
@router.post("/{course_id}/enroll", response_model=CourseEnrollmentSchema, status_code=status.HTTP_201_CREATED)
def enroll_student(
    course_id: str,
